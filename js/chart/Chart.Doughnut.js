(function(){
	...
	var defaultConfig = {
		...
		//Label shown in the center of the graph
		labelName : "Default",
	...
	Chart.Type.extend({
		...
		draw : function(easeDecimal){
			...
			//draw chart's name in the center
		...
		switchState : function( isOn )
		{
			...
			if( isOn )
			{
				...
				this.chart.ctx.strokeRect(0,0,this.chart.ctx.canvas.width,this.chart.ctx.canvas.height);
			}
			else
			{
